...
public class GraczVsGracz extends JPanel {
    ...
    public GraczVsGracz() {
        ...
        WynikX = new JLabel("Gracz X: " + pktX);
        WynikO = new JLabel("Gracz O: " + pktO);
        ...
        InfoGracz = new JLabel("Ruch gracza: " + Gracz,  JLabel.CENTER);
    ...
    private void klik(int row , int col) {
        ...
        if(CzyWygrana(Gracz)){
            InfoGracz.setText("Wygral gracz: " + Gracz);
            if(Gracz == 'X'){
                pktX += 1;
                WynikX.setText("Gracz X: " + pktX);

            }else if(Gracz == 'O'){
                pktO += 1;
                WynikO.setText("Gracz O: " + pktO);
            }
            ...
            if (Gracz == 'X') {
                ...
                Przyciski[row][col].setForeground(Color.decode("#4DA6FF"));
            }
            return;
        ...
        InfoGracz.setText("Ruch gracza: " + Gracz);
